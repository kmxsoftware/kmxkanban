...
wget https://github.com/kmxsoftware/kmxkanban/releases/download/v1.1.0/kmxkanban-v1.1.0-linux-ubuntu2204-amd64

# Make executable
chmod +x kmxkanban-v1.1.0-linux-ubuntu2204-amd64

# Run the application
./kmxkanban-v1.1.0-linux-ubuntu2204-amd64
```
...
wget https://github.com/kmxsoftware/kmxkanban/releases/download/v1.1.0/kmxkanban-v1.1.0-linux-ubuntu2404-amd64

# Make executable
chmod +x kmxkanban-v1.1.0-linux-ubuntu2404-amd64

# Run the application
./kmxkanban-v1.1.0-linux-ubuntu2404-amd64
```
