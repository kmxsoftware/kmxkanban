...
<div align="center">
  <img src="https://img.shields.io/badge/version-1.0.8beta-blue.svg" alt="Version">
...
wget https://github.com/kmxsoftware/kmxkanban/releases/download/v1.0.8beta/kmxkanban-v1.0.8beta-linux-ubuntu2204-amd64

# Make executable
chmod +x kmxkanban-v1.0.8beta-linux-ubuntu2204-amd64

# Run the application
./kmxkanban-v1.0.8beta-linux-ubuntu2204-amd64
```
...
wget https://github.com/kmxsoftware/kmxkanban/releases/download/v1.0.8beta/kmxkanban-v1.0.8beta-linux-ubuntu2404-amd64

# Make executable
chmod +x kmxkanban-v1.0.8beta-linux-ubuntu2404-amd64

# Run the application
./kmxkanban-v1.0.8beta-linux-ubuntu2404-amd64
```
